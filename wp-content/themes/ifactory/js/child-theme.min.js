! function(t, e) {
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        ...
                        var s, a, l, c, h, u, f, d, p, m, g, _, v = void 0 !== r ? r : e.gpuAcceleration,
                            ...
                            D = void 0,
                            I = void 0;
                        if (I = "bottom" === C ? "HTML" === y.nodeName ? -y.clientHeight + w.bottom : -E.height + w.bottom : w.top, D = "right" === T ? "HTML" === y.nodeName ? -y.clientWidth + w.right : -E.width + w.right : w.left, v && S) b[S] = "translate3d(" + D + "px, " + I + "px, 0)", b[C] = 0, b[T] = 0, b.willChange = "transform";
                        else {
                            var A = "bottom" === C ? -1 : 1,
                                O = "right" === T ? -1 : 1;
                            b[C] = I * A, b[T] = D * O, b.willChange = C + ", " + T
                        }
                        var N = {
        ...
        ze = function() {
            ...
            return t.toggle = function() {
                    ...
                    if (c._clearMenus(), !e) {
                        ...
                        if (p(t).trigger(i), !i.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = t : m.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(t).addClass(He), this._popper = new be(o, this._menu, this._getPopperConfig())
                            }
                ...
                var t = p(this._element.parentNode),
                    e = qe;
                return t.hasClass(ke) ? (e = Ue, p(this._menu).hasClass(Pe) && (e = Be)) : t.hasClass(Le) ? e = Qe : t.hasClass(xe) ? e = Ye : p(this._menu).hasClass(Pe) && (e = Ke), e
        ...
        Hn = function() {
            ...
            return t.enable = function() {
                ...
                var e = this,
                    ...
                    o = function() {
                        e._hoverState !== Tn && n.parentNode && n.parentNode.removeChild(n), e._cleanTipClass(), e.element.removeAttribute("aria-describedby"), p(e.element).trigger(e.constructor.Event.HIDDEN), null !== e._popper && e._popper.destroy(), t && t()
                    };
                if (p(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (p(n).removeClass(An), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[xn] = !1, this._activeTrigger[Ln] = !1, this._activeTrigger[kn] = !1, p(this.tip).hasClass(In)) {
    ...
    var gi = "bs.tab",
        ...
        Li = function() {
            ...
            return t.show = function() {
                ...
                if (p(t).addClass(bi), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), m.reflow(t), p(t).addClass(Ti), t.parentNode && p(t.parentNode).hasClass(Ei)) {
    ...
    var xi = "toast",
        ...
        Qi = function() {
            ...
            return t.show = function() {
                ...
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Wi) && this._element.classList.remove(Wi), p(this._element).off(Ri.CLICK_DISMISS), p.removeData(this._element, Pi), this._element = null, this._config = null
            }, t._getConfig = function(t) {
                return t = l({}, qi, p(this._element).data(), "object" == typeof t && t ? t : {}), m.typeCheckConfig(xi, t, this.constructor.DefaultType), t
            }, t._setListeners = function() {
                var t = this;
    ...
    p.fn[xi] = Qi._jQueryInterface, p.fn[xi].Constructor = Qi, p.fn[xi].noConflict = function() {
            return p.fn[xi] = ji, Qi._jQueryInterface
        },
        function() {
            if (void 0 === p) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var t = p.fn.jquery.split(" ")[0].split(".");
            if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), t.Util = m, t.Alert = g, t.Button = k, t.Carousel = at, t.Collapse = Ct, t.Dropdown = ze, t.Modal = pn, t.Popover = zn, t.Scrollspy = mi, t.Tab = Li, t.Toast = Qi, t.Tooltip = Hn, Object.defineProperty(t, "__esModule", {
            value: !0
        })
}),
function() {
